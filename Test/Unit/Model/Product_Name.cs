...
public class Product_Name : Product_
{
    ...
    {
        Product sut = new Product(null, Randomiser.APrice, yesterday);
    ...
    {
        Product sut = new Product(empty, Randomiser.APrice, yesterday);
        ModelStateTester.Do(sut);
    }
    ...
    {
        Product sut = new Product(space, Randomiser.APrice, yesterday);
        ModelStateTester.Do(sut);
    }
